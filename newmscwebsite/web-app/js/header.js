...
function fullformValidation() {
	...
	if (firstName != "" && lastName != "" && email != "" && address != ""
		...
		var myJSONText = "{'firstName':'" + firstName + "','lastName':'"
				+ lastName + "','email':'" + email + "','address':'" + address
				+ "','city':'" + city + "','state':'" + state + "','country':'"
				+ country + "','zip':'" + zip + "','phone':'" + phone
				+ "','cardnumber':'" + cardnumber + "','cvc':'" + cvc
				+ "','invoiceid':'" + invoiceid + "','month':'" + month
				+ "' ,'year':'" + year + "','amount':'" + amount
				+ "','street':'" + street + "','recuringType':'" + recuringType
...
function showEmailinfo() {
	...
	if (name != "" && email_id != "" && cvc_2 != "" && invoiceid_2 != ""
			&& cardnumber_2 != "") {

		var myJSONText = "{'name':'" + name + "','email_id':'" + email_id
				+ "','cvc_2':'" + cvc_2 + "','invoiceid_2':'" + invoiceid_2
				+ "','month':'" + month_1 + "' ,'year':'" + year_1
...
function showNonifo() {
	...
	if (cvc_3 != "" && invoiceid_3 != "" && cardnumber_3 != "") {
		...
		var myJSONText = "{'cvc_3':'" + cvc_3 + "','invoiceid_3':'"
				+ invoiceid_3 + "','month':'" + month_3 + "' ,'year':'"
				+ year_3 + "','amount':'" + amount + "','cardnumber':'"
