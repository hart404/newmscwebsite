...
function Epoch(name,mode,targetelement)
{
  this.state = 0;
  this.name = name;
  ...
  {
    this.mycontainer = targetelement;
    this.mycontainer.appendChild(this.calendar);
  }
...
Epoch.prototype.createMainHeading = function () //PRIVATE: Creates the primary calendar heading, with months & years
{
  ...
  mycontainer.setAttribute('id',this.name+'_mainheading');
  this.setClass(mycontainer,'mainheading');
  ...
  mycontainer.appendChild(monthDn);
  mycontainer.appendChild(this.monthSelect);
  mycontainer.appendChild(this.yearSelect);
  mycontainer.appendChild(monthUp);
  return mycontainer;
};
//-----------------------------------------------------------------------------
Epoch.prototype.createFooter = function () //PRIVATE: creates the footer of the calendar - goes under the calendar cells
{
  ...
  mycontainer.appendChild(clearSelected);
  return mycontainer;
};
//-----------------------------------------------------------------------------
