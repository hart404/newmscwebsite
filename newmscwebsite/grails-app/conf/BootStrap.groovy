	...
	void createHikes() {
		...
		if (!Hike.count()) {
			...
			def taliesinOverlook = new Hike(
				...
				noteworthyFeatures: "Taliesin Overlook has extensive views northwest and looks down onto Frank Lloyd WrightÕs Taliesin West, his winter home and school. Taliesin is still active as a school of architecture.",
				directions: "Follow the trail to the...",
