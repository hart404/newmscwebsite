...
<body>
    ...
    $(document).ready(function() {
        ...
        var prod_desc= '${product_inst.productDescription}'

        var prod_img= '${product_inst.productImageUrl}'

           

        	 $('#image_div').attr('src', "../"+prod_img+"")
        	 
         if(prod_desc){
             
        	 document.getElementById('product_description').value=prod_desc
		...
		<div class="homePageItem marginRight"  style="background: ;width: 100%;">
			...
			<div class="generalContainer">
			  ...
			  <div id="productContainingDiv" style="background:;" class="formContainer">
			     <g:uploadForm controller='product' action='updateProduct'>
			         ...
			         <div id="product_image_div" style="width: 100%;background: ;">
			            <div style="width:20%;background:;height:200px;float:left;"  id="image_containing_div">
			               <img alt="" src="../imageFile/00000140-57e4-eeb5-da82-2b7916fd3080.png" id="image_div">
			            </div>
			           ...
			           <div style="width: 100%;background: ;">
			            <div style="width:20%;background:;float:left;" >
			             ...
			             <div style="width:80%;background:;">
			                  <input type = "text" style="width: 35%;" id="product_name" name="product_name" value ="${product_inst.productName}"/>
			             </div>
			         </div>
			          ...
			          <div  style="width: 100%;background: ;visibility:hidden;height: 5px;">.</div>
			           ...
			           <div style="width: 100%;background: ;">
			            <div style="width:20%;background:;float:left;" >
			             ...
			             <div style="width:80%;background:;">
			                  <input type = "text" style="width: 35%;" id="product_title" name="product_title" value ="${product_inst.productTitle}"/>
			             </div>
			         </div>
			          ...
			          <div  style="width: 100%;background: ;">
			            <div style="width:20%;background:;float:left;" >
			             ...
			             <div style="width:80%;background:;">
			                  <input type = "text" style="width: 35%;" id="unit_price" name="unit_price"  value ="${product_inst.unitPrice}"/>
			             </div>
			         </div>
			          ...
			          <div  style="width: 100%;background: ;">
			            <div style="width:20%;background:;float:left;" >
			             ...
			             <div style="width:80%;background:;">
			                  <input type = "text"  style="width: 35%;" id="promotional_price" name="promotional_price" value ="${product_inst.promotionalPrice}"/>
			             </div>
			         </div>
			         ...
			         <div  style="width: 100%;background: ;">
			            <div style="width:20%;background:;float:left;" >
			             ...
			             <div style="width:80%;background:;">
			                  <input type = "text"  style="width: 35%;"  id="quantity" name="quantity" value ="${product_inst.quantity}"/>
			             </div>
			         </div>
			          ...
			          <div  style="width: 100%;background: ;">
			             ...
			             <div style="width:80%;background:red;">
			                     ...
			                     <input type="button" value="Cancel" onclick="window.location = 'productList' "  style="float:left"  class="saveBtn"/>
			                  
			                     <input type="submit" value="Update"   style="float:left" class="saveBtn"/>
			                     
			                
			             </div>
			            
			         </div>
			     	  <g:hiddenField name="product_id" value="${product_inst.id}" />
			     </g:uploadForm>
