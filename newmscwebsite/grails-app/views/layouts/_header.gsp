					...
					<g:form action="donateInfo" name="cardInfoForm" id="cardInfoForm" class="newclass">
						...
						<div style="">
							<div style="width: 100%; background:; float: left;">
								<label style="visibility: hidden;">Na</label> <label Style="font-weight: bold;">Contact Information</label>
							</div>
						...
						<div style="">
							<div style="width: 30%; background:; float: left;">
								<label style="visibility: hidden;">Na</label> <label>Street:</label>
							</div>
						...
						<div style="">
							...
							<g:countrySelect type="text" name="country" id="country" value="${ params?.country}" noSelection="['':'-Choose your country-']" multiple="false" style="width:202px;" />
						</div>
						...
						<div style="">
							<div style="width: 30%; background:; float: left;">
								<label style="visibility: hidden;">Na</label> <label>CVC:</label>
							</div>
						...
						<div style="">
							<div style="width: 30%; background:; float: left;">
								<label style="visibility: hidden;">Na</label> <label>Invoice Id:</label>
							</div>
                                              ...
                                              <g:form  action="cartInfo"  id="cartInfoForm" class="newclass" name="cartInfoForm">
                                                  ...
                                                  <div style="width:100%;background:;height:140px;">
                                                   ...
                                                   <div style="width: 61%; background:; float: left;">
														...
														<span style="margin-left: 40px;float: left;font-size: 18px; ">16435 N Scottsdale Rd Ste #110 </span>
