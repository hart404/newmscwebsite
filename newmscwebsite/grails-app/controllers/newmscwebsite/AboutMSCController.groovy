	...
	def history = {
		render(contentType: "text/xml") {
			data() {
				...
				event('start': startDate, 'title':"Expansion recommended", 'link':"http://localhost:8080/richuitest/person/show/3", "MSC hires its first staff member, a full time Executive Director, Sandy Bahr.")
				...
				event('start': startDate, 'title':"Preserve expanded further", 'link':"http://localhost:8080/richuitest/person/show/3", "In partnership with the City, MSC purchases 31 acres of land outside of the RSB and donates it to the Preserve.")
				...
				event('start': startDate, 'title':"Lost Dog construction starts", 'link':"http://localhost:8080/richuitest/person/show/3", "Due to drought conditions and heat lightning, the Preserve closed early in the summer to prevent potential wildfires. MSC provides vital assistance in enforcing the closure. Construction began on the Lost Dog Wash Trailhead at 124th street north of Via Linda.")

				startDate = new Date(106, 0, 1, 0, 0, 0).format("MMM dd yyyy HH:mm:ss")
				event('start': startDate, 'title':"Conservancy office opens", 'link':"http://localhost:8080/richuitest/person/show/3", "Thanks to the generosity of the Pederson Group Inc., MSC opens its first office in the Scottsdale Promenade Corporate Complex.  And - it came with a beautiful view of the Preserve through the front door!")
				...
				event('start': startDate, 'title':"Gateway opens", 'link':"http://localhost:8080/richuitest/person/show/3", "The LEED Platinum Gateway Trailhead opens. It features a state-of-the-art green building, amphitheater, and new trail connectivity. MSC donates, designs, and creates a new, barrier-free nature trail at the Gateway.  The Bajada Nature Trail opens the Preserve to those with mobility challenges and quickly becomes a family favorite!")
			}
		}
	}
}
